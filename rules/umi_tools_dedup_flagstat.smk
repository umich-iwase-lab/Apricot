...
rule umi_tools_dedup_flagstat:
    ...
    output:
        OUTPUT_DIR + '/06-umi_tools_dedup_flagstat/{sample}.genome.umi_tools_dedup_flagstat.flagstat',
    log:
        OUTPUT_DIR + '/06-umi_tools_dedup_flagstat/.log/{sample}.genome.umi_tools_dedup_flagstat.log'
    benchmark:
